...
//takes a multi demintional array and turns it into a single dementional array
...
function dominantDirection(text) {
  let scriptCount = countBy(text, char => {
    ...
    if (scriptCount.length === 0){
      return 'ltr';
    }
    return scriptCount.reduce((a, b) => a.count > b.count ? a : b).name;
}
//imma be honest, I understand almost nothing about the above functions. Pretty much just ripped straight from the book and tweaked it til it worked.
